	...
	<xsl:template match="/">
		<html lang="en-AU" xml:lang="en-AU">
			<head>
				...
				<link type="text/css" rel="stylesheet" media="screen" href="/_styles/html5.css" />
			</head>
			<body>
				<header>
					<h1><a href="/"><img src="/_images/head-html5.jpg" width="0" height="0" alt="" />Marc Greenstock w/ HTML5</a></h1>
					<nav>
						<ul>
							<li><a href="/">Home</a></li>
				...
				<footer>
					...
					<nav>
						<ul>
							<li><a href="?template=public">Switch to XHTML</a></li>
							<li><a href="/source-code/">Source Code</a></li>
							<li>
								<a href="http://html5.validator.nu/?doc=http://www.marcgreenstock.com/">
									<xsl:attribute name="href">
										<xsl:text>http://html5.validator.nu/?doc=http://www.marcgreenstock.com/</xsl:text>
										<xsl:for-each select="/config/pathSet/path">
											<xsl:value-of select="concat(.,'/')" />
										</xsl:for-each>
										<xsl:text>?template=html5</xsl:text>
									</xsl:attribute>
									<xsl:text>Vaid HTML5</xsl:text>
								</a>
							</li>
						</ul>
					</nav>
...
pageTracker._trackPageview();
	...
	<xsl:include href="overwrites.xsl" />
